...
val keystorePassword = providers.gradleProperty("KEYSTORE_PASSWORD")
    .orElse(providers.environmentVariable("KEYSTORE_PASSWORD"))
    .orElse("clipboardmemory")

android {
    namespace = "com.clipboardmemory"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.clipboardmemory"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0.0"
